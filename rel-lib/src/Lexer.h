...
enum class DataType { RequirementsSpecification, RequirementsData, Unknown };
...
class Lexer {
   ...
   protected:
    ...
    /* Adds a new token to the internal list of tokens
     * Req: dsl1, dsl2, dsl3, dsl4, dsl5, dsl6, dsl7, dsl8, dsl9
     */
     ...
     * Req: dsl1, dsl2, dsl3, dsl4, dsl5, dsl6, dsl7, dsl8, dsl9
     */
    void CheckStringandAddToken(std::string &, char const next_char = 0);
